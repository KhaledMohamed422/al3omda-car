...
class OfferAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.offer_data = {
            ...
            "is_item_active": True,
            "products": [self.product1.uuid, self.product2.uuid],
    ...
    def test_get_offer_detail(self):
        ...
        url = reverse("offers-detail", kwargs={"pk": offer.uuid})
    ...
    def test_delete_offer(self):
        ...
        self.assertFalse(Offer.objects.filter(uuid=offer.uuid).exists())
