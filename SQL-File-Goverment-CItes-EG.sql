...
INSERT INTO locations_governorate (id, governorate_name_ar, governorate_name_en) VALUES
(1, 'القاهرة', 'Cairo'),
(2, 'الجيزة', 'Giza'),
...
INSERT INTO locations_city (governorate_id, city_name_ar, city_name_en) VALUES
...
(4, ' الدقهلية الجمالية', 'aljamalia d'),
(4, 'شربين', 'Sherbin'),
(4, 'المطرية الدقهلية', 'Mataria d'),
(4, 'بلقاس', 'Belqas'),
...
(5, 'سفاجا', 'Safaga'),
(5, 'القصير', 'El Qusiar'),
(5, ' البخر الاحمر مرسى علم', 'Marsa Alam red'),
(5, 'الشلاتين', 'Shalatin'),
(5, 'حلايب', 'Halaib'),
(5, 'الدهار', 'Aldahar');
/* End Red Sea ID:5 */
...
(9, 'نفيشة', 'Nefesha');
(9, 'الشيخ زايد اسماعلية', 'Sheikh Zayed Ismailia');
/* End Ismailia ID:9 */
...
INSERT INTO locations_city (governorate_id, city_name_ar, city_name_en) VALUES
(20, 'الزقازيق', 'Zagazig'),
(20, ' الزقازيقالعاشر من رمضان', 'Al Ashr Men Ramadan zagazig'),
...
(23, 'السلوم', 'Salloum'),
(23, 'سيوة', 'Siwa'),
(23, 'مطروح مارينا', 'Marina matrouh'),
